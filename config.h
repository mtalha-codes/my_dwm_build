...
static const char *idemanagercmd[] = {"jetbrains-toolbox", NULL};
static const char *taskmgrcmd[] = {"alacritty", "-e", "btop","-u", "100", NULL };
static const char *editorcmd[] = {"alacritty", "-e", "nvim", NULL};
static const char *cxxidecmd[] = {"clion", NULL};
/* Web app commands using xdg-open */
static const char *chatgptcmd[]   = { "webapp-launch", "https://chatgpt.com", NULL };
static const char *claudecmd[] = {"webapp-launch", "https://claude.ai/new", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask|ControlMask, XK_j,                      spawn,          {.v = idemanagercmd } },
    { MODKEY|ShiftMask,             XK_n,                      spawn,          {.v = editorcmd } },
    { MODKEY|ControlMask,           XK_t,                      spawn,          {.v = taskmgrcmd } },
    { MODKEY|ShiftMask|ControlMask, XK_p,                      spawn,          {.v = cxxidecmd } },
    { MODKEY|ShiftMask,             XK_a,                      spawn,          {.v = claudecmd } },
    { MODKEY,                       XK_b,                      spawn,          {.v = browsercmd} },
    { MODKEY,                       XK_p,                      spawn,          SHCMD ("flameshot full -p ~/Pictures/Screenshots/")},
    { MODKEY|ShiftMask,             XK_p,                      spawn,          SHCMD ("flameshot full --clipboard")},
    ...
    { MODKEY|ControlMask|AltMask,   XK_r,                      spawn,          SHCMD("systemctl reboot")},
    { MODKEY|ControlMask|AltMask,   XK_s,                      spawn,          SHCMD("systemctl suspend")},
    { MODKEY|ControlMask|AltMask,   XK_p,                      spawn,          SHCMD("shutdown now") },
};
